...
The boxplot without transformation show us that the data is not symetric, it is, in fact, very skewed to the left - The median and the 3rdQu are the same: 2.
...
# t.test between two datsetes same sample.
```
...
Remember here we include the Unallocated are included.
